...
from embed_orig_task2vec import Task2Vec
from omegaconf import DictConfig, OmegaConf


@hydra.main(config_path="conf/config_task2vec.yaml")
def main(cfg: DictConfig):
    ...
    probe_network = get_model(cfg.model.arch, pretraining=cfg.model.pretraining,
