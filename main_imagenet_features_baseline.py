...
from embed_imagenet_feature_averaging import Task2VecImageNetFeatures
from omegaconf import DictConfig, OmegaConf


@hydra.main(config_path="conf/config_imagenet_feature_averaging.yaml")
def main(cfg: DictConfig):
    ...
    probe_network = get_model(cfg.model.arch, pretraining='imagenet',
                              num_classes=train_dataset.num_classes)
    probe_network = probe_network.to(cfg.device)
    embedding = Task2VecImageNetFeatures(probe_network, **cfg.task2vec).embed(train_dataset)
