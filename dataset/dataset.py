...
class TaskDataset(data.Dataset):
    ...
    def num_classes(self):
        ...
        # For attributes, might have case like [0, 2, 3] where need output dimension 4 for argmax to work correctly
        if self.metadata['dataset'] == 'cub_attributes':
            return max(self.possible_labels)+1
        else:
